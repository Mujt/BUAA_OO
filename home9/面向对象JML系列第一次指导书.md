...
|  2   | PATH_ADD -3 0 5<br />PATH_ADD -2 0<br />PATH_REMOVE 0 -2<br />PATH_COUNT<br />PATH_SIZE<br />COMPARE_PATHS 1 2<br />PATH_CONTAINS_NODE 1 -3 | Ok, path id is 1.<br />Ok, path id is 2.<br />Failed, path not exist.<br />Total count is 2.<br />Ok, path size is 3.<br />Ok, path 1 is less than to 2.<br />Yes. |
